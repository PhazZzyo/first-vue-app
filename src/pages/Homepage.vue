<template>
    <main class="homepage">
        <SectionWithHeaderSpacer>
            ...
            <Container>
                <p v-if="!filteredApartments.length">No results</p>
                <ApartmentsList v-else :items="filteredApartments">
                    <template v-slot:apartment="{ apartment }">
                        <ApartmentsItem :key="apartment.id" :id="apartment.id" :descr="apartment.desc"
...
import Container from '../components/shared/ContainerBox';
